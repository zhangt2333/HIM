...
public class Bean_fileinfo implements Serializable 
{
	...
	public final void setFileindex(int fileindex)
	{
	...
	{
		return "Bean_fileinfo [name=" + name + ", md5=" + md5 + ", file=" + file + ", type=" + type + ", size=" + size
				+ ", length=" + length + ", path=" + path + ", uploadTime=" + uploadTime + ", uploader=" + uploader
				+ ", fileindex=" + fileindex + "]";
	}
